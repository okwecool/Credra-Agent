...
from tests.entry.test_v2_entry_dialogue import Model, policy_data
from tests.entry.test_v2_ui_execution import Models, policy_dict
...
def test_entry_llm_draft_reaches_real_financial_report_without_intent_reparse(settings):
    ...
    from tests.agentic.test_v2_coordinator import finish_decision
...
def test_legacy_p25_task_keeps_its_historical_intent_charge_when_entry_resumes(
    ...
    from credra_agent.graph import workflow
    from tests.entry.test_v2_ui_execution import run as run_old_ui
