...
V2-2 已进入 P21 证据与实体处理，见 [P21 实施记录](docs/V2-2%20P21%20证据与实体处理实施记录.md)。agentic 调查保留原始研究返回值，并落盘证据图、主张与 Observation 引用；旧版整体“已核验”标记不再自动完成用户问题。证据驱动重规划和首例财务计算分别在 P22/P24 推进。
